...
<head>
    <meta charset="UTF-8" />
    <title> Course Registration Payment Gateway</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    ...
                    <h1 class="title">Welcome to Tours And Travels payment</h1>
                ...
                <div class="col">
                    ...
                    <div id="success" class="success hidden">
                        ...
                        <p>
                            <?php if ($success) {
                            ?>
                                <button class="btn btn-success" onclick="window.open('viewcust-book.php','_self')">Confirm</button>
                            <?php
                            }
                            ?> </p> <?php
