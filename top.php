	 		...
	 		<div class="top-nav">
	 			...
	 			<div class="menu">
	 				<ul id="nav">
	 					...
	 					<li>
	 						<a href="login.php" onclick="javascript:window.open('login.php','_self')">Login</a>
	 					</li>
	 					<li>
	 						<a href="register.php" onclick="javascript:window.open('register.php','_self')">Register</a>
	 					</li>
