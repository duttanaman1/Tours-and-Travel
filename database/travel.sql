...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2020 at 11:27 AM
...
INSERT INTO `book` (`bookid`, `tripid`, `name`, `date`, `days`, `hotel`, `transport`, `price`, `status`) VALUES
(2, 1, 'cust1', '2020-06-01', 2, 'hotel1', 'trans2', 400, 'booked'),
(3, 1, 'cust1', '2020-06-01', 2, 'hotel1', 'trans2', 400, 'paid'),
(4, 1, 'cust1', '2020-06-17', 2, 'hotel1', 'trans2', 400, 'paid'),
(5, 3, 'cust1', '2020-06-14', 3, 'hotel2', 'trans1', 6230, 'paid'),
(6, 3, 'cust1', '2020-06-14', 7, 'hotel lakeview', 'jeep', 24700, 'paid'),
(7, 3, 'cust33', '2020-06-14', 5, 'himalayan hotel', 'jeep', 12700, 'paid');
...
INSERT INTO `cust` (`custid`, `name`, `password`, `email`, `mobile`, `price`) VALUES
(1, 'cust1', 'cust1', 'cust1', '1234567879', 0),
(2, 'cust33', 'cust33', 'cust33', '1234567890', 0);
...
INSERT INTO `emp` (`empid`, `name`, `password`) VALUES
(1, 'emp1', 'emp1'),
(2, 'emp2', 'emp2'),
(3, 'emp7', 'emp7'),
(4, 'emp33', 'emp33');
...
INSERT INTO `hotel` (`id`, `tripid`, `name`, `price`) VALUES
(1, 1, 'hotel1', 100),
(2, 1, 'hotel2', 150),
(3, 2, 'hotel21', 350),
(4, 3, 'hotel1', 3000),
(5, 3, 'hotel2', 2000),
(6, 3, 'hotel lakeview', 3500),
(7, 3, 'himalayan hotel', 2500);
...
INSERT INTO `transport` (`id`, `tripid`, `name`, `price`) VALUES
(2, 1, 'trans2', 200),
(3, 1, 'trans3', 250),
(4, 2, 'trans21', 200),
(5, 3, 'trans1', 230),
...
INSERT INTO `trip` (`tripid`, `name`, `desp`) VALUES
(1, 'trip1', 'trip1 description'),
(2, 'trip2', 'trip2 desp'),
(3, 'trip pokhara', 'pokhara trip description');
